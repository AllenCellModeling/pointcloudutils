...
def main():
    ...
    run_name = 'run_name1'
    save_checkpoint_dir = f'/allen/aics/modeling/ritvik/projects/wandb_checkpoints/'
    ...
    with open("/allen/aics/modeling/ritvik/projects/cytodl-internal-configs/data/pcna/nuc_bound/intensity_cropped_img_2d.yaml", "r") as stream:
