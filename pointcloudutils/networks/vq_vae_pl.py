...
# from .vq_modules.abstract_modules.base_autoencoder import BaseVQVAE
# from .vq_modules.autoencoder import Encoder, Decoder
# from .vq_modules.loss.loss import VQLPIPSWithDiscriminator
# from .vq_modules.vector_quantizers import VectorQuantizer, EMAVectorQuantizer, GumbelVectorQuantizer, \
...
#         # import ipdb
#         # ipdb.set_trace()
#         images = self.preprocess_batch(batch[0] if isinstance(batch, list) else batch)
