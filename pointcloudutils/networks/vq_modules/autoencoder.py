...
class Encoder(nn.Module):
    def __init__(self, channels: int, num_res_blocks: int, channel_multipliers: tuple, embedding_dim: int):
        ...
        self.conv_in = torch.nn.Conv2d(1, channels, kernel_size=(3, 3), stride=(1, 1), padding=1, bias=False)
...
class Decoder(nn.Module):
    def __init__(self, channels: int, num_res_blocks: int, channel_multipliers: tuple, embedding_dim: int):
        ...
        self.conv_out = torch.nn.Conv2d(channels, 1, kernel_size=(3, 3), stride=(1, 1), padding=1)
