...
def main():
    ...
    run_name = 'run_name1'
    save_checkpoint_dir = f'/allen/aics/modeling/ritvik/projects/npm1_sdf_checkpoints/'
    ...
    with open("/allen/aics/modeling/ritvik/projects/cytodl-internal-configs/data/variance_npm1/variance_2d_npm1_align.yaml", "r") as stream:
